...
var fileDescriptor_a61802764a7d7e5a = []byte{
	...
	0x4f, 0xcb, 0xcf, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4e, 0xcb, 0xcf, 0x57, 0xe2,
	0xe1, 0xe2, 0x72, 0xcb, 0xcf, 0x0f, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x51, 0x92, 0xe7, 0xe2,
	0x06, 0xf3, 0x8a, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0x85, 0x04, 0xb8, 0x98, 0x73, 0x8b, 0xd3, 0x25,
	0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x40, 0x4c, 0x23, 0x4b, 0xb0, 0xf2, 0xe0, 0xd4, 0xa2, 0xb2,
	0xcc, 0xe4, 0x54, 0x21, 0x6d, 0x2e, 0xb6, 0xf4, 0xd4, 0x12, 0xb7, 0xfc, 0x7c, 0x21, 0x7e, 0x3d,
	0x90, 0xb9, 0x08, 0x93, 0xa4, 0x04, 0x10, 0x02, 0x10, 0xc3, 0x92, 0xd8, 0xc0, 0xb6, 0x1a, 0x03,
	0x02, 0x00, 0x00, 0xff, 0xff, 0x75, 0x15, 0xb3, 0xf8, 0x86, 0x00, 0x00, 0x00,
}
...
func (c *fooServiceClient) GetFoo(ctx context.Context, in *FooRequest, opts ...grpc.CallOption) (*FooResponse, error) {
	out := new(FooResponse)
	err := c.cc.Invoke(ctx, "/foo.FooService/getFoo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedFooServiceServer) GetFoo(ctx context.Context, req *FooRequest) (*FooResponse, error) {
...
func _FooService_GetFoo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/foo.FooService/GetFoo",
	}
